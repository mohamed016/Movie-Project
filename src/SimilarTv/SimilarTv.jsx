...
export default function SimilarTv() {
    ...
    async function movieDetails() {
        let { data } = await axios.get(`https://api.themoviedb.org/3/tv/${params.id}?api_key=679feeef7bb8213791d03a04134cf6c5&language=en-US`)
    ...
    async function similarMovie() {
        ...
        let { data } = await axios.get(`https://api.themoviedb.org/3/tv/${params.id}/similar?api_key=679feeef7bb8213791d03a04134cf6c5&language=en-US&page=1`)
        if (data.length != 0) {
                ...
                <table className="table table-striped table-bordered ">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{MovieDetails.first_air_date}</td>
                        </tr>
                        <tr>
                            <td>Count of view</td>
            ...
            <div>
                ...
                <div className='containerCompanyLogo'>
                    {MovieCompany.map((e, index) => <div className=' companyLogo text-center' key={index}>
                        <div className='imgContainer'>{e.logo_path ? <img className=" w-100 poster" src={'https://image.tmdb.org/t/p/w500' + e.logo_path} /> : <img className=" w-100 " src={pic} />}</div>
